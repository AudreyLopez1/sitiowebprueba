...
#configuro el token
setToken("2fa5d117cbf9876765a3b0ce1a2f98bb1e4cc41738a69f3d70ddd633142f9bf7")

```

#Introducción

En esta pagina web se hace un análisis muy sencillo del desempeño de las remuneraciones medios reales  en los sectores mananufactura y comercial. Esto en comparación del indice nacional de precios al consumidor(INCP).
...
1. Remuneraciones medias reales del sector manufecturero con el Id Banxico SL11439.
2. Remuneraciones medias reales del sector comercio con el Id Banxico SL11432.
3. INCP con el Id Banxico SP1.

Por cuestiones de disponibilidad en las bases de datos , se extrajo la información desde enero de 2008 a septiembre de 2023.

#Desarrorro

Esto llevó a los siguientes datos de la siguiente tabla:
...
El desempeño historicó de estos 3 índices se puede contrastar en la giguiente gráfica:
